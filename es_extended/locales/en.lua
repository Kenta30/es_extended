Locales['en'] = {
  ...
  ['noammo'] = 'Nincs lőszered!',
  ['gave_item'] = 'you gave ~y~%sx~s~ ~b~%s~s~ to ~y~%s~s~',
  ['received_item'] = 'Kaptál ~y~%sx~s~ ~b~%s~s~ Tőle ~b~%s~s~',
  ['gave_weapon'] = 'Adtál ~b~%s~s~ Neki ~y~%s~s~',
  ...
  ['received_weapon'] = 'Kaptál ~b~%s~s~ Tőle ~b~%s~s~',
  ...
  ['gave_account_money'] = 'Adtál ~g~$%s~s~ (%s) Neki ~y~%s~s~',
  ['received_account_money'] = 'Kaptál ~g~$%s~s~ (%s) tőle ~b~%s~s~',
  ['amount_invalid'] = 'Érvénytelen összeg',
  ['players_nearby'] = 'Nincs játékos a közelben',
  ...
  ['threw_standard'] = 'Eldobtál ~y~%sx~s~ ~b~%s~s~',
  ['threw_account'] = 'Eldobtál ~g~$%s~s~ ~b~%s~s~',
  ['threw_weapon'] = 'Eldobtál ~b~%s~s~',
  ['threw_weapon_ammo'] = 'Eldobtál ~b~%s~s~ Ezzel ~o~%sx %s~s~',
  ['threw_weapon_already'] = 'Már van nálad ilyen fegyver',
  ['threw_cannot_pickup'] = 'Nem fér el nálad több tárgy!',
  ['threw_pickup_prompt'] = 'Nyomj ~y~E~s~ felvétel',
  ...
  ['in_vehicle'] = 'Nem adhatod át járműben',
